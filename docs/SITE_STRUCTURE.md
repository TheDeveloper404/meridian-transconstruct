...
Meniu principal confirmat ca pagini individuale: Acasă, Servicii, Proiecte, Despre, Contact. CTA: „Cere o ofertă”. Pagini separate, cu URL-uri descriptive și breadcrumb pe paginile interioare.
...
3. **Context factual:** „Din 2019”, „Petroșani · Valea Jiului”, „Firme · instituții · persoane fizice”. Fără număr de clienți, procente sau promisiuni inventate.
4. **Servicii:** patru categorii cu explicație scurtă și link către paginile dedicate.
5. **Proiecte selectate:** maximum trei lucrări reale, fotografii dominante, tip lucrare și localitate. Numărul total nu se afirmă public înaintea inventarului verificat.
6. **Despre:** prezentare scurtă și legătură spre pagina firmei. Nu afirmăm existența unor certificări sau a unei echipe interne neverificate.
...
8. **Footer:** nume legal, CUI, Registrul Comerțului, contact și linkuri către datele firmei/confidențialitate/cookies.
...
## Formular — propunere UX, nu contract API
...
Informare de confidențialitate lângă formular; nu adăugăm marketing implicit. Temeiul prelucrării și forma informării se stabilesc pe fluxul real. Stări: inițial, validare cu erori lângă câmpuri, trimitere în curs, succes, eroare cu datele păstrate și alternativă telefonică. Nu promitem răspuns în 24 de ore fără acordul firmei.
...
Confirmate prin feedback: pagini individuale, albastru închis, hero cu fundal imagine, eliminarea telefonului din header, serviciul „Construcții civile” și CTA spre Contact pe Acasă. Rămân de primit logo-ul și fotografiile; conținutul detaliat al paginilor rămâne de aprobat. Hostingul nu se rediscută acum: se configurează la deploy. Confirmarea acestor propuneri nu înlocuiește verificările înainte de lansare.
