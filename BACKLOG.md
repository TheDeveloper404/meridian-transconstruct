...
| A-008 | `ASSUMED — needs ratification` Footer închis la culoare (`ink-deep`), textul nou al secțiunii „Despre firmă” (fără „Viziunea noastră”, păstrată) și textele panoului de pe Contact. | Footer-ul închis permite aceeași tranziție oblică la finalul fiecărei pagini; textele folosesc doar fapte din brief. |
